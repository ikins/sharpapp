...
<head>
    ...
    <meta name="keywords" content="sharp, sharp virtual exhibiton"/>
    <meta name="description" content="sharp virtual exhibiton beyound future the ultimate innovation"/>
...
<body class="layout-top-nav">
    ...
    <div class="arc-container" id="bg_video">
        <div class="arc-reactor"> 
            ...
            <embed id="intro" src="<?= base_url(); ?>assets/intro.mp3" type="audio/mp3" autostart="true" hidden="true">
                <audio autoplay loop id="audio-intro">
                    <source src="<?= base_url(); ?>assets/intro.mp3" type="audio/mp3">
    ...
    <div class="vid">
        ...
        <a href="#" id="skip-btn" type="button" style="display: none;">
            <img class="skip" src="<?= base_url(); ?>assets/images/skip.png">
        </a>
    </div>  
    <!-- frame -->
    <div id="menu" style="display: none;">
        <div class="row menu-link">
            ...
            <div class="col-md-2  col-2 text-center  px-0">
                <a type="button" class="menu_link" href="<?= base_url(); ?>feedback/form" target="_new">
                    <img class="icononframefd" src="<?= base_url(); ?>assets/images/new-feedback.png">
                </a>
            </div>
    ...
    <div class="kuula" style="display: none;">
        <div class="arrows">
            <div class="left-arrows">
                <lottie-player src="https://assets2.lottiefiles.com/packages/lf20_phhgogmt.json"  background="transparent"  speed="1"   loop  autoplay></lottie-player>
            </div>
            <div class="right-arrows">
                <lottie-player src="https://assets6.lottiefiles.com/packages/lf20_cguot7ul.json"  background="transparent"  speed="1"  loop  autoplay></lottie-player>
            </div>
        </div>
