  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Visitor Buy Shopee <?php echo date('d M Y', strtotime($today)); ?> <small class="badge badge-info p-t-10 p-b-10 p-r-10 p-l-10"><i class="fas fa-map-marker"></i>
              &nbsp; <?php echo $count_all; ?>
            </small></h1>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap" id="tabledashboard">
                  ...
                  <tbody>
                    ...
                    <?php
                      switch ($rows->vb_product_category) {
                        case '1':
                          $pc = 'Audio Visual';
                          break;
                    ...
                    <tr>
                      <td><?php echo $i; ?></td>
                      <td><?php echo $rows->vb_ip; ?></td>
                      <td><?php echo date('d M Y', strtotime($rows->vb_date)); ?></td>
                      <td><?php echo $pc; ?></td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
