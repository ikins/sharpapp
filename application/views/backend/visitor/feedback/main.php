        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Feedback All</span>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Feedback Today</span>
                <span class="info-box-number">
                  4
                </span>
              </div>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap" id="tabledashboard">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $i; ?></td>
                      <td><?php echo $rows->vf_ip; ?></td>
                      <td><?php echo date('d M Y', strtotime($rows->vf_date)); ?></td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
                </table>
